...
var resizePizzas = function(size) {
    ...
    // DEPRECATED due to performence issue
    ...
    function changePizzaSizes(size) {
        ...
        //loop ramdomPizzas and set width according selected size in the slider.
        for (var i = 0; i < ramdomPizzas.length; i++) {
            ramdomPizzas[i].style.width = percSize + "%";
        }
    }

    //call function to change the size of all pizzas in the background according to the slider
...
function updatePositions() {
    ...
    //get scroll position before looping
